...
import MulticitySearchForm from "../flightSearchForm/multicitySearchForm/MulticitySearchForm";
import ReturnSearchFormDummy from "../flightSearchForm/returnSearchForm/ReturnSearchFormDummy";
import OnewaySearchFormDummy from "../flightSearchForm/onewaySearchForm/OnewaySearchFormDummy";
...
const FlightSearchFormDummy = () => {
  ...
  const renderForm = () => {
    return (
      <form className="w-full mx-2 md:mx-0  container relative rounded-[10px] border-1 border-gray-300 shadow-2xl bg-white ">
        {renderRadioBtn()}

        {dropOffLocationType == "oneway" && (
          <div className="flex flex-1 rounded-full">
            <OnewaySearchFormDummy
...
export default FlightSearchFormDummy;
