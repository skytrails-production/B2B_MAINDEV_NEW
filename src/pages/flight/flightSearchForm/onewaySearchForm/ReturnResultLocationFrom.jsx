...
// import ClearDataButton from "../DatePickerCustomHeaderTwoMonth../ClearDataButton";
...
const ReturnResultLocationFrom = ({
  autoFocus = false,
  ...
  return (
    <div className={`relative flex ${className}`} ref={containerRef}>
      <div
        ...
        className={`flex z-10 flex-1 relative [ p-3 ] flex-shrink-0 items-center space-x-3 cursor-pointer focus:outline-none text-left ${
...
export default ReturnResultLocationFrom;
