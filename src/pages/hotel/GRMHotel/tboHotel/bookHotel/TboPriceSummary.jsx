...
function TboPriceSummary(props) {
  ...
  return (
    <>
      <div className="top-24 rounded-md shadow-sm border-1 border-gray-300 overflow-y-scroll bg-white p-7 sticky">
        <div className=" flex flex-col w-full border-1 border-gray-300 rounded-md">
          <div className=" flex flex-row justify-center items-center">
            <div className="p-3 w-full border-b border-gray-300 flex flex-col gap-2 justify-center items-center">
              <p className="text-sm  text-gray-700 mb-0">Check-In</p>
            ...
            <div className="p-3 w-full border-b border-gray-300 flex flex-col gap-2 justify-center items-center">
              <p className="text-sm text-gray-700 mb-0">Check-Out</p>
              <p className="text-sm font-semibold text-gray-800 mb-0">
        ...
        <div className="sideBarPriceBox">
          <PayButton
            ...
            setLoadingButton={(state) => {
              // setLoadingButton(state);
              console.log("setLoadingButton(state)", state);
            }}
