    ...
    return (
      <>
        ...
        <div className="flex-grow text-left">
          <span className="block text-white text-base md:text-2xl font-bold">
    ...
    >
      {({ open, close }) => (
        <>
          ...
          {open && (
            <div className="h-8 absolute self-center top-1/2 -translate-y-1/2 z-0 -inset-x-0.5 bg-background-6000"></div>
          )}
          ...
          >
            <Popover.Panel className="absolute left-1/2 z-30 mt-[-40px] top-full w-screen max-w-sm -translate-x-1/2 transform px-4 sm:px-0 lg:max-w-3xl">
              <div className="overflow-hidden rounded-3xl shadow-lg ring-1 ring-black ring-opacity-5 border-1 border-gray-500 bg-background-6000 p-8 z-50">
                <DatePicker
                  selected={startDate}
...
export default StayDatesRangeInputHold;
