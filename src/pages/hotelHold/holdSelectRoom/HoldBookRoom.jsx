...
import HoldAmenities from "./HoldAmenities";
import ModalMap from "../../hotel/GRMHotel/ModalMap";
import HoldHotelGalleryCarousel from "./HoldHotelGalleryCarousel";
...
const HoldBookRoom = () => {
  ...
  useEffect(() => {
    if (
      ...
      navigate("/hotelhold/hotelresult");
    }
  }, [reducerState?.hotelSearchResultGRN?.hotelDetails?.data?.data?.errors]);
  ...
  const handleClickSaveRoom = () => {
    ...
    navigate("/hotelhold/hotelresult/selectroom/guestDetails");
  };
  ...
  return (
    <>
      {loader ? (
        <BlurredLoader textData={"Searching best rooms for you !"} />
      ) : (
