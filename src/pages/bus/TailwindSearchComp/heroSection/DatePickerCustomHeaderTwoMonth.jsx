  ...
  return (
    <div>
      <button
        ...
        className="react-datepicker__navigation react-datepicker__navigation--previous absolute -top-1 left-0 flex items-center justify-center p-2 rounded-full hover:bg-gray-100 "
      ...
      <span className="react-datepicker__current-month text-gray-300 ">
